...
var Game = {
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('Michael wins!'); }, 1000);
            } else {
        ...
        // Check to see if the ai/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () { Pong.endGameMenu('Samuel wins!'); }, 1000);
        }
    },
    ...
    draw: function () {
        ...
        this.context.font = '100px Sigmar';
